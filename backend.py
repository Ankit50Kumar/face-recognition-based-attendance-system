...
def load_known_faces():
    ankit_image = face_recognition.load_image_file("C://Users//DELL//OneDrive//Desktop//face//student pic//ankit.jpg")
    ankit_encoding = face_recognition.face_encodings(ankit_image)[0]
    raushan_image = face_recognition.load_image_file("C://Users//DELL//OneDrive//Desktop//face//student pic//raushan.jpg")
    raushan_encoding = face_recognition.face_encodings(raushan_image)[0]
    satyam_image = face_recognition.load_image_file("C://Users//DELL//OneDrive//Desktop//face//student pic//satyam.jpg")
    satyam_encoding = face_recognition.face_encodings(satyam_image)[0]
    pragya_image = face_recognition.load_image_file("C://Users//DELL//OneDrive//Desktop//face//student pic//pragya.jpg")
